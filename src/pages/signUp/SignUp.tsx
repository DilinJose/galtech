...
interface SignupFormValues {
    ...
    dob: string;
    address: string;
    profileImage: string; // Base64 format
    password: string;
    confirmPassword: string;
    role: "admin" | "user" | "";
}
...
const Signup = () => {
    ...
    const handleImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                setValue("profileImage", reader.result as string); // Set Base64 image in form data
            };
    ...
    const onSubmit: SubmitHandler<SignupFormValues> = (data) => {
        ...
        navigate(ROUTERS.logIn); // Redirect after successful signup
    };
