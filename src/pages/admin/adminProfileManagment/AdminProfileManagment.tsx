...
const AdminProfileManagement = () => {
    ...
    const {
        ...
        defaultValues: userDetails, // Set form default values
    });
    ...
    const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                setValue("profileImage", base64String); // Update form value
    ...
    const onSubmit: SubmitHandler<FormValues> = (data) => {
        ...
        dispatch(updateUserDetails(data)); // Dispatch action to update Redux store
    };
